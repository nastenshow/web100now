...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <meta charset="utf-8" />
        ...
        <title>{{ config('web100now.name') }} | @yield('title')</title>
        <meta name="web100now-version" content="{{ Storage::get('web100now/version.md') }}">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="/dashboard"><i class="fab fa-fw fa-linux"></i> {{ config('web100now.name') }}</a>
        ...
        <div id="layoutSidenav">
            ...
            <div id="mainloading" class="d-none">
                <p><i class="fas fa-circle-notch fa-spin" id="mainloadingicon"></i> {{ __('web100now.loading_data') }}...</p>
            </div>
            @yield('extra')
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="errorModalLabel">{{ __('web100now.system_error') }}</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <p>{{ __('web100now.unknown_error') }}</p>
                            <div class="space"></div>
                        </div>
                    </div>
                </div>
        ...
        <script>
            ...
            $('#panelversion').html($('meta[name="web100now-version"]').attr('content'));
