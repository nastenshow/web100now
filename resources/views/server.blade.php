...
<ol class="breadcrumb mb-4">
    ...
    <li class="ml-1 breadcrumb-item active">{{ __('web100now.sites') }}:<b><span class="ml-1" id="serversites"></span></b></li>
    ...
    <div class="col-xl-6">
        <div class="card mb-4">
            <div class="card-header">
                ...
                {{ __('web100now.server_cpu_realtime_load') }}
            </div>
            <div class="card-body">
    ...
    <div class="col-xl-6">
        <div class="card mb-4">
            <div class="card-header">
                ...
                {{ __('web100now.server_ram_realtime_load') }}
            </div>
            <div class="card-body">
...
<div class="row">
    ...
    <div class="col-xl-4">
        <div class="card mb-4">
            <div class="card-header">
                ...
                {{ __('web100now.system_services') }}
            </div>
            <div class="card-body">
                <p>nginx</p>
                <div class="text-center">
                    <button class="btn btn-warning" type="button" id="restartnginx">{{ __('web100now.restart') }} <i class="fas fa-circle-notch fa-spin d-none" id="loadingnginx"></i></button>
                </div>
                <div class="space"></div>
                <p>PHP-FPM</p>
                <div class="text-center">
                    <button class="btn btn-warning" type="button" id="restartphp">{{ __('web100now.restart') }} <i class="fas fa-circle-notch fa-spin d-none" id="loadingphp"></i></button>
                </div>
                <div class="space"></div>
                <p>MySql</p>
                <div class="text-center">
                    <button class="btn btn-warning" type="button" id="restartmysql">{{ __('web100now.restart') }} <i class="fas fa-circle-notch fa-spin d-none" id="loadingmysql"></i></button>
                </div>
                <div class="space"></div>
                <p>Redis</p>
                <div class="text-center">
                    <button class="btn btn-warning" type="button" id="restartredis">{{ __('web100now.restart') }} <i class="fas fa-circle-notch fa-spin d-none" id="loadingredis"></i></button>
                </div>
                <div class="space"></div>
                <p>Supervisor</p>
                <div class="text-center">
                    <button class="btn btn-warning" type="button" id="restartsupervisor">{{ __('web100now.restart') }} <i class="fas fa-circle-notch fa-spin d-none" id="loadingsupervisor"></i></button>
                </div>
                <div class="space"></div>
            </div>
        </div>
    ...
    <div class="col-xl-4">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <p>{{ __('web100now.php_cli_version') }}:</p>
                <div class="input-group">
                ...
                <div class="space"></div>
                <p>{{ __('web100now.manage_cron_jobs') }}:</p>
                <div>
                    <button class="btn btn-primary" type="button" id="editcrontab">{{ __('web100now.edit_crontab') }}</button>
                </div>
                <div class="space"></div>
                <p>{{ __('web100now.reset_web100now_password') }}:</p>
                <div>
                    <button class="btn btn-danger" type="button" id="rootreset">{{ __('web100now.require_reset_web100now_password') }}</button>
                </div>
                <div class="space"></div>
                <p>{{ __('web100now.hd_memory_usage') }}:</p>
                <div>
                    <span class="btn" id="hd"><i class="fas fa-circle-notch fa-spin" title="{{ __('web100now.loading_data') }}"></i></span>
                </div>
                <div class="space"></div>
                <p>{{ __('web100now.web100now_build_version') }}:</p>
                <div>
    ...
    <div class="modal-dialog" role="document" id="updateserverdialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateServerModalLabel">{{ __('web100now.update_server_modal_title') }}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p>{{ __('web100now.update_server_modal_text') }}</p>
                <p class="d-none" id="ipnotice"><b>{!! __('web100now.update_server_modal_ip') !!}</b></p>
                <div class="text-center">
                    <button class="btn btn-primary" type="button" id="submit">{{ __('web100now.confirm') }} <i class="fas fa-circle-notch fa-spin d-none" id="loading"></i></button>
                </div>
                <div class="space"></div>
            </div>
        </div>
...
<div class="modal fade" id="crontabModal" tabindex="-1" role="dialog" aria-labelledby="crontabModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="crontabModalLabel">{{ __('web100now.server_crontab') }}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p>{{ __('web100now.server_crontab_edit') }}:</p>
                <div id="crontab" style="height:250px;width:100%;"></div>
                <div class="space"></div>
                <div class="text-center">
                    <button class="btn btn-primary" type="button" id="crontabsubmit">{{ __('web100now.save') }} <i class="fas fa-circle-notch fa-spin d-none" id="crontableloading"></i></button>
                </div>
                <div class="space"></div>
            </div>
        </div>
...
<div class="modal fade" id="rootresetModal" tabindex="-1" role="dialog" aria-labelledby="rootresetModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="rootresetModalLabel">{{ __('web100now.require_password_reset_modal_title') }}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p>{{ __('web100now.require_password_reset_modal_text') }}</p>
                <div class="space"></div>
                <div class="text-center">
                    <button class="btn btn-danger" type="button" id="rootresetsubmit">{{ __('web100now.confirm') }} <i class="fas fa-circle-notch fa-spin d-none" id="rootresetloading"></i></button>
                </div>
                <div class="space"></div>
            </div>
        </div>
...
<script>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(data.build) {
                    ...
                    $('#serverbuild').html('{{ __('web100now.unknown') }}');
                }
                switch (data.php) {
                    case '8.1':
    ...
    function getPing() {
        $.ajax({
            ...
            beforeSend: function() {
                $('#serverping').empty();
                $('#serverping').html('<i class="fas fa-circle-notch fa-spin" title="{{ __('web100now.loading_data') }}"></i>');
            },
            success: function(data) {
                $('#serverping').empty();
    ...
    $('#changephp').click(function() {
        $.ajax({
            ...
            beforeSend: function() {
                $('#changephp').html('<i class="fas fa-circle-notch fa-spin" title="{{ __('web100now.loading_please_wait') }}"></i>');
            },
            success: function(data) {
                $('#changephp').empty();
    ...
    $('#rootresetsubmit').click(function() {
        ...
        $.ajax({
            ...
            type: 'POST',
            success: function(data) {
                success('{{ __('web100now.new_password_success') }}:<br><b>'+data.password+'</b>');
                $(window).scrollTop(0);
