...
<ol class="breadcrumb mb-4">
    ...
    <li class="ml-1 breadcrumb-item active">{{ __('web100now.aliases') }}:<b><span class="ml-1" id="sitealiases"></span></b></li>
    <li class="ml-1 breadcrumb-item active">PHP:<b><span class="ml-1" id="sitephp"></span></b></li>
    <li class="ml-1 breadcrumb-item active">{{ __('web100now.site_base_path') }}:<b><span class="ml-1">/home/</span><span id="siteuserinfo"></span>/web/<span id="sitebasepathinfo"></span></b></li>
</ol>
<div class="row">
    <div class="col-xl-6">
        <div class="card mb-4">
            <div class="card-header">
                ...
                {{ __('web100now.basic_information') }}
            </div>
            <div class="card-body">
                <p>{{ __('web100now.domain') }}:</p>
                <div class="input-group">
                    <input class="form-control" type="text" placeholder="e.g. domain.ltd" id="sitedomain" autocomplete="off" />
                </div>
                <div class="space"></div>
                <p>{{ __('web100now.site_base_path') }}:</p>
                <div class="input-group">
                    <input class="form-control" type="text" placeholder="e.g. public" id="sitebasepath" autocomplete="off" />
                </div>
                <div class="space"></div>
                <div class="text-center">
                    <button class="btn btn-primary" type="button" id="updateSite">{{ __('web100now.update') }} <i class="fas fa-circle-notch fa-spin d-none" id="updateSiteloading"></i></button>
                </div>
                <div class="space"></div>
            </div>
        </div>
    ...
    <div class="col-xl-6">
        <div class="card mb-4">
            <div class="card-header">
                ...
                {{ __('web100now.manage_aliases') }}
            </div>
            <div class="card-body">
                <p>{{ __('web100now.add_alias') }}:</p>
                <div class="input-group">
...
<div class="row">
    <div class="col-xl-4">
        <div class="card mb-4">
            <div class="card-header">
                ...
                {{ __('web100now.ssl_security') }}
            </div>
            <div class="card-body">
                <p>{{ __('web100now.ssl_security_text') }}:</p>
                <button class="btn btn-success btn" type="button" id="sitessl">{{ __('web100now.ssl_generate') }} <i class="fas fa-circle-notch fa-spin d-none" id="sitesslloading"></i></button>
                <div class="space"></div>
                <div class="space"></div>
                <p>{{ __('web100now.password_resets') }}:</p>
    ...
    <div class="col-xl-4">
        <div class="card mb-4">
            <div class="card-header">
                ...
                {{ __('web100now.github_repository') }}
            </div>
            <div class="card-body">
                <p>{{ __('web100now.github_repository_setup') }}</p>
                <div class="text-center">
                    <button class="btn btn-warning" type="button" style="min-width:200px" id="sitesetrepo">{{ __('web100now.github_repository_config') }}</button>
                    <div class="space"></div>
                </div>
                <div class="text-center">
                    <button class="btn btn-warning" type="button" style="min-width:200px" id="editdeploy">{{ __('web100now.github_repository_scripts') }}</button>
                    <div class="space"></div>
                </div>
                <p>
                    {{ __('web100now.github_repository_deploy') }}:
    ...
    <div class="col-xl-4">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <p>{{ __('web100now.php_fpm_version') }}:</p>
                <div class="input-group">
                ...
                <div class="space"></div>
                <div class="text-center">
                    <button class="btn btn-primary" type="button" id="sitesupervisorupdate">{{ __('web100now.update') }} <i class="fas fa-circle-notch fa-spin d-none" id="sitesupervisorupdateloading"></i></button>
                </div>
                <div class="space"></div>
            </div>
        </div>
    ...
    <div class="modal-dialog" role="document" id="repositorydialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="repositoryModalLabel">{{ __('web100now.github_repository') }}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <label for="repositoryproject">{{ __('web100now.repository_project') }}</label>
                <div class="input-group">
                    <input class="form-control" type="text" id="repositoryproject" placeholder="e.g. johndoe/helloworld" autocomplete="off" />
                </div>
                <div class="space"></div>
                <label for="repositorybranch">{{ __('web100now.repository_branch') }}</label>
                <div class="input-group">
                    <input class="form-control" type="text" id="repositorybranch" placeholder="e.g. develop" autocomplete="off" />
                </div>
                <div class="space"></div>
                <label for="deploykey">{{ __('web100now.repository_deploy_key') }} {!! __('web100now.repository_deploy_key_info') !!}</label>
                <div class="input-group">
                    <textarea id="deploykey" readonly style="width:100%;height:150px;font-size:10px;"></textarea>
                </div>
                <div class="space"></div>
                <div class="text-center">
                    <button class="btn btn-primary" type="button" id="repositorysubmit">{{ __('web100now.confirm') }} <i class="fas fa-circle-notch fa-spin d-none" id="repositoryloading"></i></button>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="deployModal" tabindex="-1" role="dialog" aria-labelledby="deployModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deployModalLabel">{{ __('web100now.deploy_scripts') }}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p>{{ __('web100now.github_repository_scripts') }}:</p>
                <div id="deploy" style="height:250px;width:100%;"></div>
                <div class="space"></div>
                <div class="text-center">
                    <button class="btn btn-primary" type="button" id="deploysubmit">{{ __('web100now.save') }} <i class="fas fa-circle-notch fa-spin d-none" id="deployloading"></i></button>
                </div>
                <div class="space"></div>
            </div>
        </div>
...
<div class="modal fade" id="sshresetModal" tabindex="-1" role="dialog" aria-labelledby="sshresetModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="sshresetModalLabel">{{ __('web100now.require_password_reset_modal_title') }}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p>{{ __('web100now.require_ssh_password_reset_modal_text') }}</p>
                <div class="space"></div>
                <div class="text-center">
                    <button class="btn btn-danger" type="button" id="sshresetsubmit">{{ __('web100now.confirm') }} <i class="fas fa-circle-notch fa-spin d-none" id="sshresetloading"></i></button>
                </div>
                <div class="space"></div>
            </div>
        </div>
...
<div class="modal fade" id="mysqlresetModal" tabindex="-1" role="dialog" aria-labelledby="mysqlresetModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="mysqlresetModalLabel">{{ __('web100now.require_password_reset_modal_title') }}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p>{{ __('web100now.require_mysql_password_reset_modal_text') }}</p>
                <div class="space"></div>
                <div class="text-center">
                    <button class="btn btn-danger" type="button" id="mysqlresetsubmit">{{ __('web100now.confirm') }} <i class="fas fa-circle-notch fa-spin d-none" id="mysqlresetloading"></i></button>
                </div>
                <div class="space"></div>
            </div>
        </div>
...
<script>
    ...
    $('#sshresetsubmit').click(function() {
        $.ajax({
            ...
            success: function(data) {
                success('{{ __('web100now.new_ssh_password_success') }}:<br><b>'+data.password+'</b><br><a href="'+data.pdf+'" target="_blank" style="color:#ffffff">{{ __('web100now.download_site_data') }}</a>');
    ...
    $('#mysqlresetsubmit').click(function() {
        $.ajax({
            ...
            success: function(data) {
                success('{{ __('web100now.new_mysql_password_success') }}:<br><b>'+data.password+'</b><br><a href="'+data.pdf+'" target="_blank" style="color:#ffffff">{{ __('web100now.download_site_data') }}</a>');
