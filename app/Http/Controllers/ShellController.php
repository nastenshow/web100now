...
class ShellController extends Controller
{
    ...
    */
    public function setup(string $server_id)
    {
        ...
        $script = Storage::get('web100now/setup.sh');
    ...
    */
    public function deploy(string $site_id)
    {
        ...
        $script = Storage::get('web100now/deploy.sh');
    ...
    */
    ...
    {
        $script = Storage::get('web100now/rootreset.sh');
    ...
    */
    ...
    {
        $script = Storage::get('web100now/newsite.sh');
    ...
    */
    ...
    {
        $script = Storage::get('web100now/delsite.sh');
    ...
    */
    ...
    {
        $script = Storage::get('web100now/sitepass.sh');
    ...
    */
    ...
    {
        $script = Storage::get('web100now/patch202112091.sh');
    ...
    */
    ...
    {
        $script = Storage::get('web100now/patch202112101.sh');
    ...
    */
    ...
    {
        $script = Storage::get('web100now/patch202112181.sh');
